...
# 拉取PassWall源码
git clone https://github.com/xiaorouji/openwrt-passwall-packages.git package/xiaorouji/packages
...
cd -
git clone https://github.com/xiaorouji/openwrt-passwall.git package/xiaorouji/luci
