...
# 拉取PassWall源码
git clone https://github.com/xiaorouji/openwrt-passwall-packages.git package/xiaorouji
#git clone -b packages https://github.com/lxhao61/openwrt-passwall.git package/xiaorouji
...
#git clone -b luci https://github.com/lxhao61/openwrt-passwall.git package/xiaorouji
